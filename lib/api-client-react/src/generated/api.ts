...
export const getCreateProfileUrl = () => {
  ...
  return `/api/edu/profile`
}

/**
 * @summary Save applicant questionnaire answers
 */
export const createProfile = async (profileInput: ProfileInput, options?: RequestInit): Promise<ApplicantProfile> => {

  return customFetch<ApplicantProfile>(getCreateProfileUrl(),
  {
    ...options,
    method: 'POST',
...
export const getGetProfileUrl = (id: number,) => {
  ...
  return `/api/edu/profile/${id}`
}

/**
 * @summary Get applicant profile
 */
export const getProfile = async (id: number, options?: RequestInit): Promise<ApplicantProfile> => {

  return customFetch<ApplicantProfile>(getGetProfileUrl(id),
  {
    ...options,
    method: 'GET'
...
export const getGenerateRecommendationsUrl = () => {
  ...
  return `/api/edu/recommendations`
}

/**
 * @summary Generate AI-powered study direction recommendations
 */
export const generateRecommendations = async (recommendationsRequest: RecommendationsRequest, options?: RequestInit): Promise<RecommendationResult> => {

  return customFetch<RecommendationResult>(getGenerateRecommendationsUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getGenerateRecommendationsMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof generateRecommendations>>, TError,{data: BodyType<RecommendationsRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof generateRecommendations>>, TError,{data: BodyType<RecommendationsRequest>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof generateRecommendations>>, {data: BodyType<RecommendationsRequest>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type GenerateRecommendationsMutationBody = BodyType<RecommendationsRequest>
...
export const getMatchUniversitiesUrl = () => {
  ...
  return `/api/edu/universities`
}

/**
 * @summary Get matched Moscow universities based on profile
 */
export const matchUniversities = async (universitiesRequest: UniversitiesRequest, options?: RequestInit): Promise<UniversitiesResult> => {

  return customFetch<UniversitiesResult>(getMatchUniversitiesUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(universitiesRequest)
  }
);}
...
export const getMatchUniversitiesMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof matchUniversities>>, TError,{data: BodyType<UniversitiesRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof matchUniversities>>, TError,{data: BodyType<UniversitiesRequest>}, TContext> => {

const mutationKey = ['matchUniversities'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof matchUniversities>>, {data: BodyType<UniversitiesRequest>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type MatchUniversitiesMutationBody = BodyType<UniversitiesRequest>
...
export const useMatchUniversities = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof matchUniversities>>, TError,{data: BodyType<UniversitiesRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        {data: BodyType<UniversitiesRequest>},
        TContext
      > => {
      return useMutation(getMatchUniversitiesMutationOptions(options));
    }

export const getGenerateProgramsUrl = () => {




  return `/api/edu/programs`
}

/**
 * @summary Generate EGE preparation programs for selected university
 */
export const generatePrograms = async (programsRequest: ProgramsRequest, options?: RequestInit): Promise<PrepPlanResult> => {

  return customFetch<PrepPlanResult>(getGenerateProgramsUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(programsRequest)
  }
);}
...
export const getGenerateProgramsMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof generatePrograms>>, TError,{data: BodyType<ProgramsRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof generatePrograms>>, TError,{data: BodyType<ProgramsRequest>}, TContext> => {

const mutationKey = ['generatePrograms'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof generatePrograms>>, {data: BodyType<ProgramsRequest>}> = (props) => {
          const {data} = props ?? {};

          return  generatePrograms(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type GenerateProgramsMutationResult = NonNullable<Awaited<ReturnType<typeof generatePrograms>>>
    export type GenerateProgramsMutationBody = BodyType<ProgramsRequest>
    export type GenerateProgramsMutationError = ErrorType<unknown>

    /**
 * @summary Generate EGE preparation programs for selected university
 */
export const useGeneratePrograms = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof generatePrograms>>, TError,{data: BodyType<ProgramsRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof generatePrograms>>,
        TError,
        {data: BodyType<ProgramsRequest>},
        TContext
      > => {
      return useMutation(getGenerateProgramsMutationOptions(options));
    }
